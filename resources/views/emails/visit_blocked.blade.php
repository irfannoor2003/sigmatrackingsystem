@include('emails._header', ['title' => 'Visit Blocked'])

<tr>
    <td style="padding:22px 18px;">
        <h2 style="margin:0 0 12px 0;color:#dc2626;font-size:18px;">🚫 Visit Automatically Blocked</h2>

        <p style="font-size:14px;line-height:1.65;color:#374151;">Dear {{ $salesmanName }},</p>

        <p style="font-size:14px;line-height:1.65;color:#374151;">Your visit has been automatically blocked because it was not completed by 8:00 PM today.</p>
        ...
        <ul style="padding-left:20px;margin:8px 0;font-size:14px;color:#374151;">
            ...
            <li>Blocked at: {{ $visit->blocked_at->format('M d, Y h:i A') }}</li>
        </ul>

        <p style="font-size:14px;line-height:1.65;color:#374151;">You can now contact your administrator to request an unblock. Once unblocked, you can complete the visit normally.</p>
