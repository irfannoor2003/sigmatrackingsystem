...
<div class="report-main p-0 sm:p-0">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-lg relative overflow-hidden">
            <div class="absolute top-3 right-3 opacity-20">
                <i data-lucide="calendar-check" class="w-12 h-12 text-blue-400"></i>
            </div>
            <p class="text-white/60 text-sm mb-1">Today's Visits</p>
            <h3 class="text-3xl font-bold text-white">{{ $todayVisits }}</h3>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-lg relative overflow-hidden">
            ...
            <h3 class="text-3xl font-bold text-green-400">{{ $todayCompleted }}</h3>
        </div>

        <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-lg relative overflow-hidden">
            <div class="absolute top-3 right-3 opacity-20">
                <i data-lucide="clock" class="w-12 h-12 text-yellow-400"></i>
            </div>
            <p class="text-white/60 text-sm mb-1">Pending</p>
            <h3 class="text-3xl font-bold text-yellow-400">{{ $todayPending }}</h3>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-lg relative overflow-hidden">
            ...
            <p class="text-white/60 text-sm mb-1">Blocked</p>
            <h3 class="text-3xl font-bold text-red-400">{{ $todayBlocked }}</h3>
        </div>

    </div>

    {{-- Today's Salesmen & Companies --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">

        <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-lg">
            <div class="flex items-center gap-3 mb-4">
                <div class="w-10 h-10 bg-blue-500/20 rounded-full flex items-center justify-center">
                    <i data-lucide="users" class="w-5 h-5 text-blue-400"></i>
                </div>
                <h3 class="text-white font-semibold">Today's Salesmen</h3>
            </div>
            @if($todaySalesmen->isNotEmpty())
                <div class="flex flex-wrap gap-2">
                    @foreach($todaySalesmen as $name)
                        <span class="px-3 py-1 bg-blue-500/20 border border-blue-400/30 text-blue-300 rounded-full text-sm">
                            {{ $name }}
                        </span>
                    @endforeach
                </div>
            @else
                <p class="text-white/50 text-sm">No visits today</p>
            @endif
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-5 rounded-2xl shadow-lg">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h3 class="text-white font-semibold">Today's Companies</h3>
            </div>
            @if($todayCompanies->isNotEmpty())
                <div class="flex flex-wrap gap-2">
                    @foreach($todayCompanies as $name)
                        <span class="px-3 py-1 bg-purple-500/20 border border-purple-400/30 text-purple-300 rounded-full text-sm">
                            {{ $name }}
                        </span>
                    @endforeach
                </div>
